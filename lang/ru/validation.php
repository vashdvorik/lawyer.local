...
return [
    ...
    */
    ...
    'ascii' => 'Значение поля :attribute может содержать только однобайтовые цифро-буквенные символы.',
    ...
    'can' => 'Значение поля :attribute недопустимо.',
    ...
    'digits_between' => 'Длина значения цифрового поля :attribute должна быть от :min до :max.',
    ...
    'password' => [
        ...
        'uncompromised' => 'Значение поля :attribute обнаружено в утечке данных. Пожалуйста, выберите другое значение для :attribute.',
    ],
